...
@Injectable()
export class VerificationMapper implements IMapper<
  Verification,
  PrismaVerification
> {
  toDomain(record: PrismaVerification): Verification {
    return Verification.reconstitute({
      ...
      verificationStatus:
        record.verificationStatus as unknown as VerificationStatus,
  ...
  toPersistence(entity: Verification): Omit<PrismaVerification, 'id'> {
    return {
      ...
      verificationType:
        entity.verificationType as unknown as PrismaVerificationType,
      verificationStatus:
        entity.verificationStatus as unknown as PrismaVerificationStatus,
